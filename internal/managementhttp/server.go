...
func registerClusterManagementRoutes(r *RouteRegistry, handler *clustermanagement.Handler) {
	...
	r.Set(http.MethodGet, "/billing/proxy-pools", handler.ListProxyPoolItems)
	...
	r.Set(http.MethodPost, "/billing/proxy-pools", handler.CreateProxyPoolItem)
	r.Set(http.MethodPatch, "/billing/proxy-pools/:id", handler.UpdateProxyPoolItem)
	r.Set(http.MethodDelete, "/billing/proxy-pools/:id", handler.DeleteProxyPoolItem)
	r.Set(http.MethodPost, "/billing/proxy-pools/:id/test", handler.TestProxyPoolItem)
