...
func AutoMigrate(db *gorm.DB) error {
	...
	if errMigrate := db.AutoMigrate(&AuthRecord{}, &ConfigRecord{}, &UserRecord{}, &APIKeyRecord{}, &ChannelGroupRecord{}, &ChannelGroupDetailRecord{}, &ModelGroupRecord{}, &ModelGroupDetailRecord{}, &ClusterNodeRecord{}, &ClusterEventRecord{}, &UsageRecord{}, &OAuthSessionRecord{}, &CertificateRecord{}); errMigrate != nil {
		return errMigrate
	}
