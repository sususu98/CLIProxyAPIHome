...
func (h *Handler) RegisterRoutes(group *gin.RouterGroup) {
	...
	group.GET("/channel-groups", h.ListChannelGroups)
	group.POST("/channel-groups", h.CreateChannelGroup)
	group.GET("/channel-groups/:id", h.GetChannelGroup)
	group.PUT("/channel-groups/:id", h.UpdateChannelGroup)
	group.PATCH("/channel-groups/:id", h.UpdateChannelGroup)
	group.DELETE("/channel-groups/:id", h.DeleteChannelGroup)
	group.GET("/channel-group-details", h.ListChannelGroupDetails)
	group.POST("/channel-group-details", h.CreateChannelGroupDetail)
	group.GET("/channel-group-details/:id", h.GetChannelGroupDetail)
	group.PUT("/channel-group-details/:id", h.UpdateChannelGroupDetail)
	group.PATCH("/channel-group-details/:id", h.UpdateChannelGroupDetail)
	group.DELETE("/channel-group-details/:id", h.DeleteChannelGroupDetail)
	group.GET("/model-groups", h.ListModelGroups)
	group.POST("/model-groups", h.CreateModelGroup)
	group.GET("/model-groups/:id", h.GetModelGroup)
	group.PUT("/model-groups/:id", h.UpdateModelGroup)
	group.PATCH("/model-groups/:id", h.UpdateModelGroup)
	group.DELETE("/model-groups/:id", h.DeleteModelGroup)
	group.GET("/model-group-details", h.ListModelGroupDetails)
	group.POST("/model-group-details", h.CreateModelGroupDetail)
	group.GET("/model-group-details/:id", h.GetModelGroupDetail)
	group.PUT("/model-group-details/:id", h.UpdateModelGroupDetail)
	group.PATCH("/model-group-details/:id", h.UpdateModelGroupDetail)
	group.DELETE("/model-group-details/:id", h.DeleteModelGroupDetail)
